...
const ServerResult = styled(Link)`
    ${tw`flex items-center p-4 no-underline transition-all duration-100`};
                            ...
                            {servers.map((server) => (
                                ...
                                >
                                    ...
                                    <div css={tw`flex-none text-right`}>
                                        <span css={tw`text-xs py-1 px-2`} style={{ backgroundColor: 'rgba(255, 76, 76, 0.12)', color: '#FF4C4C', borderRadius: '2px' }}>
                                            {server.node}
                                        </span>
                                    </div>
                                </ServerResult>
