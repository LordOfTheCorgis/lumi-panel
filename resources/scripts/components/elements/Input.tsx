...
const inputStyle = css<Props>`
    ...
    ${tw`p-3 text-sm transition-all duration-100`};
    ...
    &:not(:disabled):not(:read-only):focus {
        border-color: #FF4C4C;
        box-shadow: 0 0 0 1px rgba(255, 76, 76, 0.2);
        ${(props) => props.hasError && css`border-color: #FF4C4C; box-shadow: 0 0 0 1px rgba(255, 76, 76, 0.3);`};
    }
    ...
    ${(props) => props.hasError && css`color: #ffa0a0; border-color: #FF4C4C;`};
`;
