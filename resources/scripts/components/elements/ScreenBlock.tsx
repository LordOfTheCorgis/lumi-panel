    ...
    <PageContentBlock>
        <div css={tw`flex justify-center`}>
            <div
                ...
                style={{ backgroundColor: '#1a1a1a', border: '1px solid #222222', borderRadius: '4px' }}
            >
                ...
                <img src={image} css={tw`w-2/3 h-auto select-none mx-auto`} style={{ opacity: 0.6, filter: 'grayscale(30%)' }} />
                <h2 css={tw`mt-10 font-bold text-4xl`} style={{ color: '#f0f0f0' }}>{title}</h2>
                <p css={tw`text-sm mt-2`} style={{ color: '#a3a3a3' }}>{message}</p>
            </div>
        </div>
    </PageContentBlock>
);
