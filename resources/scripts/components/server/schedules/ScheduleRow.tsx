        ...
        <div>
            <p
                css={[
                    ...
                    schedule.isActive ? 'background-color: #2a2a2a; color: #a3a3a3;' : tw`bg-neutral-400`,
                ]}
            >
        ...
        <div>
            <p
                css={[
                    ...
                    schedule.isActive && !schedule.isProcessing ? 'background-color: #2a2a2a; color: #a3a3a3;' : tw`bg-neutral-400`,
                ]}
            >
